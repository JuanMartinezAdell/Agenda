                    ...
                    <div class="py-8">
                        ...
                        <div class="my-2 flex sm:flex-row flex-col">
                            ...
                            <div class="block relative">
                                ...
                                <input v-model="search" placeholder="Busqueda mediante texto" class="appearance-none rounded-r rounded-l sm:rounded-l-none border border-gray-400 border-b block w-full pl-8 pr-6 py-2 bg-white text-sm placeholder-gray-400 text-gray-700 focus:bg-white focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none" />
                                <!-- {{ search }} -->
                            </div>
                        </div>
                                        ...
                                        <tr v-for="contact in contacts.data" :key="contact.id">
                                            ...
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <span
                                                    ...
                                                    <span class="relative"> {{ contact.organization.name }}  </span>
                                                </span>
                                            </td>
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <p class="text-gray-900 whitespace-no-wrap"> {{ contact.position.name }} </p>
                                            </td>
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <p class="text-gray-900 whitespace-no-wrap">
