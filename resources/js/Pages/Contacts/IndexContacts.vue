                ...
                <div class="container mx-auto px-4 sm:px-8">
                    <div class="py-8">
                        ...
                        <div class="my-2 flex sm:flex-row flex-col">
                            <div class="flex flex-none mb-1 sm:mb-0">
                                <div class="relative">
                            ...
                            <div class="flex-none sm:pl-2  ">
                                <Button class="h-full  pl-8 pr-6 py-2" @click="closeModal">
                                    <Link :href="route('contacts.create')">Nuevo Contacto</Link>
                                </Button>
                            </div>
                        </div>
